...
import type { Trigger, TriggersObject } from "@crowbartools/firebot-custom-scripts-types/types/triggers";
...
// biome-ignore lint/suspicious/noExplicitAny: Nature of the function is to force a value to be a number, so it needs to accept any input.
